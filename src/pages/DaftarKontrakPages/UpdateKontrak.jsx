...
const UpdateKontrak = () => {
  ...
  const getKontrak = async () => {
    ...
    setTglKontrak(data.tgl_kontrak);
    setNomorKontrak(data.nomor_kontrak);
    ...
    setLabaRugi(data.laba_rugi);
  };

  const updateKontrak = async (e) => {
    e.preventDefault();
    try {
      await updateKontrakById(id, {
        tgl_kontrak,
        nomor_kontrak,
        nama_pekerjaan,
        nilai_kontrak,
